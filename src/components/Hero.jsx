  ...
  return (
    <>
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8 px-4 py-10 md:py-20 md:px-8 max-w-7xl mx-auto">
        {/* Text Content */}
        <div className="flex flex-col gap-y-4 text-center md:text-start w-full">
        ...
        <div className="w-full flex justify-center">
          <img
            src={Portrait}
            alt="Portrait"
            className="object-cover rounded-xl w-full max-w-md md:max-w-xs lg:max-w-md xl:max-w-lg transition-transform duration-300 hover:scale-105"
          />
        </div>
      </div>
    </>
